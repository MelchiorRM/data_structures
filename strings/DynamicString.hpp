...
/**
 * DynamicString - Resizable string implementation
 * Memory allocated dynamically and grows/shrinks as needed
...
public:
    ...
    DynamicString& operator=(const std::string& str);
    ...
    DynamicString operator+(const char* str) const;
    DynamicString operator+(const std::string& str) const;
    DynamicString& operator+=(const DynamicString& other);
    DynamicString& operator+=(const char* str);
    DynamicString& operator+=(const std::string& str);
