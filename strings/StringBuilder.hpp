...
/**
 * StringBuilder - Optimized string builder for frequent concatenation
...
private:
    ...
    int bufferSize; // Additional buffer for efficient appending
...
public:
    ...
    void insertLineAt(int position, const char* str);
    void insertLineAt(int position, const std::string& str);
    void insertLineAt(int position);
    void replaceLine(int lineNumber, const char* str);
    void replaceLine(int lineNumber, const std::string& str);
    void deleteLine(int lineNumber);
    void insertAtLine(int lineNumber, const char* str);
    void insertAtLine(int lineNumber, const std::string& str);
...
private:
    ...
    int findLineStart(int lineNumber) const;
    int findLineEnd(int lineNumber) const;
    int countLinesInRange(int start, int end) const;
};
